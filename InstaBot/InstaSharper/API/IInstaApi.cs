...
namespace InstaSharper.API
{
    public interface IInstaApi
    {
        ...
        ICollectionProcessor _collectionProcessor { get; set; }
        ICommentProcessor _commentProcessor { get; set; }
        AndroidDevice _deviceInfo { get; set; }
        IFeedProcessor _feedProcessor { get; set; }

        IHashtagProcessor _hashtagProcessor { get; set; }
        ILocationProcessor _locationProcessor { get; set; }
        IMediaProcessor _mediaProcessor { get; set; }
        IMessagingProcessor _messagingProcessor { get; set; }
        IUserProfileProcessor _profileProcessor { get; set; }
        IStoryProcessor _storyProcessor { get; set; }

        TwoFactorLoginInfo _twoFactorInfo { get; set; }
        InstaChallenge _challengeInfo { get; set; }
        UserSessionData _user { get; set; }
        IUserProcessor _userProcessor { get; set; }
