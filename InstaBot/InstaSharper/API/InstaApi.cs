...
namespace InstaSharper.API
{
    internal class InstaApi : IInstaApi
    {
        ...
        public readonly IInstaLogger _logger;
        public ICollectionProcessor _collectionProcessor { get; set; }
        public ICommentProcessor _commentProcessor { get; set; }
        public AndroidDevice _deviceInfo { get; set; }
        public IFeedProcessor _feedProcessor { get; set; }

        public IHashtagProcessor _hashtagProcessor { get; set; }
        public ILocationProcessor _locationProcessor { get; set; }
        public IMediaProcessor _mediaProcessor { get; set; }
        public IMessagingProcessor _messagingProcessor { get; set; }
        public IUserProfileProcessor _profileProcessor { get; set; }
